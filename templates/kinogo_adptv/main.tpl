...
[aviable=showfull]
<link rel="stylesheet" href="{THEME}/assets/dscountdown.css" />
    ...
    <div class="contener2">
      <div class="content">
        ...
        <div class="funct">
          ...
          [/aviable]
          [sort]<!--noindex-->
            <div class="funct" style="text-align:center;">{sort}</div><!--/noindex-->
          [/sort]
          {content} 
      ...
      <div class="leftblok_contener2" id="menu-head">
        <div class="leftblok1">
         ...
         <!--  <div class="mini" style="border-top:0px; padding-top:0px;">
            <i style="font-size:14px;">Жанры фильмов</i><br><br>
              ...
              <a href="/dokumentalnyy/">Документальный</a><br>
              <a href="/drama/">Драма</a><br>
              <a href="/istoricheskiy/">Исторический</a><br>
              <a href="/komediya/">Комедия</a><br>
              <a href="/kriminal/">Криминал</a><br>
              <a href="/melodrama/">Мелодрама</a><br>
              <a href="/multfilm/">Мультфильм</a><br>
        ...
        <div class="leftblok2">
          <div class="miniblock">
            ...
            <div class="mini">  
              ...
              <a href="/russkiy-serial/">Русский сериал</a><br>
              <a href="/zarubezhnyy-serial/">Зарубежный сериал</a><br>
            </div> 
          </div>
        </div>
      </div>
        ...
        <div style="padding: 7px 20px;position: relative;border-bottom: 1px solid #3f413f;">
          <i style="font-size:15px;">
            <dd class="value" style="color:orange">Скоро на киного</dd>
          </i>
        </div>

        <div class="mimiserblock">
          <ul>
            {custom category="1-24" template="custom-slider" xf="skoro" from="0" limit="2" cache="no"}
          </ul>
        </div>

        <div class="poloska_bloka"></div>

        <div style="padding: 7px 0 7px 20px;position: relative;border-bottom: 1px solid #3f413f;">
          <i style="font-size:15px;"><font color="green">Обновления сериалов на киного</font></i>
        </div>
...
<div class="header">
	<div class="header44">
    <div id="in-toolbar">
      <a id="menu-btn"><span id="hamburger"></span></a>
    </div>

		<div class="main_menu">
      <a href="/"><img src="{THEME}/images/kinogo.png" alt="смотреть киного онлайн"></a>
    </div>
  ...
  <div class="search_panel">
    <div class="searchbar"> 	
      <form action="/" name="searchform" method="post" >
        ...
        <button class="fbutton2" onclick="submit();" type="submit" title="ok" style="float: right;">
          <span>ok</span>
        </button>
      </form>
    </div>
